...
HD_PWD='D:/Xilinx/Project/200t/Fir_pass/Fir_pass.runs/fir_compiler_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_compiler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_compiler.tcl
