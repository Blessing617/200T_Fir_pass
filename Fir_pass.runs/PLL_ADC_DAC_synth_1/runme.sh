...
HD_PWD='D:/Xilinx/Project/200t/Fir_pass/Fir_pass.runs/PLL_ADC_DAC_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PLL_ADC_DAC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PLL_ADC_DAC.tcl
