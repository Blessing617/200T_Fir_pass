...
HD_PWD='D:/Xilinx/Project/200t/Fir_pass/Fir_pass.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_pass.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_pass.tcl -notrace
