...
HD_PWD='D:/Xilinx/Project/200t/Fir_pass/Fir_pass.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_pass.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_pass.tcl
