...
#
# Script generated by Vivado on Tue Feb 20 16:10:16 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : PLL_ADC_DAC.sh
...
#
# Usage        : PLL_ADC_DAC.sh
#                PLL_ADC_DAC.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PLL_ADC_DAC.sh [-reset_run]
#                PLL_ADC_DAC.sh [-reset_log]
#                PLL_ADC_DAC.sh [-help]
#
...
#                script (type 'PLL_ADC_DAC.sh -help' for more information).
#
...
# script info
echo -e "PLL_ADC_DAC.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PLL_ADC_DAC.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.PLL_ADC_DAC xil_defaultlib.glbl -o PLL_ADC_DAC_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./PLL_ADC_DAC_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key PLL_ADC_DAC_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc PLL_ADC_DAC_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./PLL_ADC_DAC.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: PLL_ADC_DAC.sh [-help]\n\
Usage: PLL_ADC_DAC.sh [-step]\n\
Usage: PLL_ADC_DAC.sh [-lib_map_path]\n\
Usage: PLL_ADC_DAC.sh [-reset_run]\n\
Usage: PLL_ADC_DAC.sh [-reset_log]\n\
Usage: PLL_ADC_DAC.sh [-keep_index]\n\
Usage: PLL_ADC_DAC.sh [-noclean_files]\n\n\
