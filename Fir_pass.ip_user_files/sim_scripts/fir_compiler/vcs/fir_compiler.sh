...
design_libs=(xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 fir_compiler_v7_2_19 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work fir_compiler_v7_2_19 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fir_compiler xil_defaultlib.glbl -o fir_compiler_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fir_compiler_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fir_compiler_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fir_compiler_simv.daidir vcs_lib c.obj)
