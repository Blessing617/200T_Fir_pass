...
#
# Script generated by Vivado on Sat Jul 27 11:13:11 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : fir_compiler.sh
...
#
# Usage        : fir_compiler.sh
#                fir_compiler.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fir_compiler.sh [-reset_run]
#                fir_compiler.sh [-reset_log]
#                fir_compiler.sh [-help]
#
...
#                script (type 'fir_compiler.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_10 -libname axi_utils_v2_0_6 -libname fir_compiler_v7_2_19 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 fir_compiler_v7_2_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fir_compiler.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fir_compiler.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fir_compiler xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fir_compiler -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fir_compiler_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fir_compiler.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fir_compiler.sh [-help]\n\
Usage: fir_compiler.sh [-step]\n\
Usage: fir_compiler.sh [-lib_map_path]\n\
Usage: fir_compiler.sh [-reset_run]\n\
Usage: fir_compiler.sh [-reset_log]\n\
Usage: fir_compiler.sh [-keep_index]\n\
Usage: fir_compiler.sh [-noclean_files]\n\n\
